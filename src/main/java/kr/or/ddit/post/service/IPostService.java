...
public interface IPostService {
	...
	* Method 설명 : 해당 게시판의 페이징 처리된 게시글 목록 조회
	 */
	//Map<String, Object> getPostPagingList(Map<String, Object> map);
	List<?> getPostPagingList(Map<String, Object> paramMap);
	
	/**
	* Method : getPostPagingListTotCnt
	* 작성자 : PC-08
	* 변경이력 :
	* @param paramMap
	* @return
	* Method 설명 : 해당 게시판의 게시글 총 수 조회
	 */
	int getPostPagingListTotCnt(Map<String, Object> paramMap);
